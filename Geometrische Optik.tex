...
\hspace{5mm} - Vernachlässigung von Wellenphänomenen (Beugung und Interferrenz)

\subsection{Spiegel}
\textbf{Grundbegriffe:} \\
\hspace{5mm} - virtuelles Bild: Im Bildpunkt treffen sich nur die Verlängerungen der Strahlen \\
\hspace{5mm} - reeles Bild: Im Bildpunkt treffen sich tatsächlich Lichtstrahlen \\[1ex]

\hspace{3mm} $G$: Gegenstandhöhe \\
\hspace{3mm} $g$: Gegenstandweite \\
\hspace{3mm} $B$: Bildhöhe \\
\hspace{3mm} $b$: Bildweite \\[1ex]

\hspace{3mm} Ebener Spiegel: $G = B$, $g = b$ \\[1ex]
...
Achsenparallel Strahlen fokussieren im Brennpunkt \\[1ex]

\textbf{Bildkonstruktion bei sphärischen Spiegel} \\
1. Der Achsenparallele Strahl wird in den Brennpunkt reflektiert \\
2. Der Brennpunktstrahl verläuft durch den Brennpunkt und wird achsenparallel \\ \hspace{2.3mm} refelektiert \\
3. Der Mittelpunkt verläuft durch den Krümmungsmittelpunkt, trifft den Spiegel und \\ \hspace{2.3mm} wird in sich selbst zurück refelektiert \\[1ex]
...
\subsection{Linsen}
Ann.: Sphärische Grenzflächen zwischen zwei Medien mit Brennzahlen $n_1$ und $n_2$ \\[1ex]
...
Für zwei dünne Linsen auf der selben optischen Achse gilt:
\begin{formulabox}
    \[
