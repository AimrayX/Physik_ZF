...
Der Fluss von elektrischen Ladungen wird als \textbf{elektrischen Strom} bezeichnet. \\[1ex]
...
\textbf{Ideale Spannungsquellen} weisen an den Polen, unabhängig vom Stromfluss, immer die selbe Quellspannung $U_Q$ auf:
\[
    I = \frac{U_Q}{R}
\]
\\[1ex]
...
\subsection{Zusammenschalten von Widerstände}
...
\]
\textbf{Ersatzkapazität für parallel geschaltete Widerstände}
\begin{formulabox}
    \[
...
\]
\textbf{Ersatzkapazität für in Reihe geschaltete Widerstände}
\begin{formulabox}
    \[
...
Anwendbar bei \textbf{stationärem (Zeit unabhängigen)} Stromfluss. \\[1ex]
...
Schaltungen mit Ohm'schen Widerstand R und Kondensator C. \\[2ex]
...
Füt $t = 0$ (Schalter geschlossen $\rightarrow$ aufladen) gilt:
\\[1ex]
\hspace{5mm} \textbf{Maschenregel:}
\[
...
\begin{formulabox}
    \[
        I(t) = \frac{dq(t)}{dt} = CU \left( \frac{1}{RC} - e^{-\frac{t}{\tau}} \right) = \frac{U}{R}e^{-\frac{t}{\tau}} = I_Ae^{-\frac{t}{\tau}}
    \]
\end{formulabox}
\vspace{2ex}
