...
\]\[
    U_{ind} = -\frac{d\Phi_{mag}}{dt} = -Bl\frac{dx(t)}{dt} = - Blv(t)
\]
...
\begin{formulabox}
    \[
       \Phi_{mag} = nBA = \mu_0 \frac{n^2}{l}AI \ \stackrel{!}{=} \ L \cdot I \ \Rightarrow \ L = \mu_0 \frac{n^2}{l}A
    \]
\end{formulabox}
...
\begin{formulabox}
    \[
        \Phi_{mag21} = n_1B_2A_1 = \mu_0 \frac{n_1n_2}{l}\pi r_1^2 I_2 \ \stackrel{!}{=} \ L_{21}I_2
    \]
\end{formulabox}
\textbf{Magnetischer Fluss von erster Spule (innen) durch zweite Spule:}
\begin{formulabox}
    \[
        \Phi_{mag12} = n_2B_1A_1 = \mu_0 \frac{n_1n_2}{l}\pi r_1^2 I_1 \ \stackrel{!}{=} \ L_{12}I_1
    \]
\end{formulabox}
