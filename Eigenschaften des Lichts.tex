...
(im sichtbaren Beriech)\\
\begin{tabular}{|c|c|c|c|c|c|}
  \hline
  Medium & Vakuum & Luft & Wasser & Glas & Diamant \\
  \hline
  Brechzahl & 1 & 1.003 & 1.33 & 1.5 ... 1.7 & 2.4 \\
  \hline
\end{tabular}
\vspace{1mm}
...
\textbf{Reflektierte Intensität:} (Spezielfall $\Theta_1 = \Theta_1' = 0$
\begin{formulabox}
    \[
...
Ab einem kritischen Einfallswinkel kann beim Eintritt in ein Medium ($n_1 > n_2$) eine \textbf{Totalreflexion} auftreten. \\[1ex]

\textbf{kritischer Winkel für Totalreflexion:}
\begin{formulabox}
    \[
        \sin{\Theta_k} = \frac{n_1}{n_2}\sin{90^{\circ}} = \frac{n_2}{n_1}
    \]
\end{formulabox}

\textbf{Dispresion:} \\
Die Brechzahl jedes Mediums hängt (geringfügig) von der Wellenlänge des eintreffenden Lichts ab. In Wellenbereichen, in denen das Matrial durchsichtig ist, nimmt die Brechzahl typischerweise mit steigender Wellenlänge ab. \\
...
Mit \textbf{Polaristoren}, die nur eine bestimmte Schwinungsrichtung des $\Vec{E}-$Vektors durchlassen, lassen unpolarisierte Wellen linear polarisieren. \\[1ex]

\subsection{Polarisationsmechanismen}
\textbf{1. Absorption:} Richtungsabhängige Absorption in ausgerichteten linearen Molekülen oder Metalfäden, Die nicht durchgelassene Polarisationsrichtung wird absorbiert \\ $\rightarrow$ Umwandlung in Wärme \\[1ex]
...
\begin{formulabox}
    \[
        \tan{\Theta_p} = \frac{n_1}{n_2}
    \]
\end{formulabox}

\textbf{3. Streuung} Reflexion und Absorption von em-Wellen an Teilchen. Reemittiertes Licht in der Ebene steht senkrecht zur Einfallsrichtung muss linear polarisiert sein.

\subsection{Lichtspektrum}
\textbf{Linienspektren:} Valenzelektronen sind für die Energieänderung im Atom zuständig, was zur Absorption führt. Die Energien des aus Atomen emittierten Lichts ist auf bestimmte Wellen beschränkt, was zu den diskreten Spektrallinien führt. \\[1ex]

\textbf{Kontinuierliche Spektren:} Wenn Atome stark mit einander wechseklwirken, dann sind viele Energieniveaus der Atome zu ununterbrochenen Bereichen von Energieniveaus verbreitet. Daraus entsteht ein zusammenhängender Bereich \\
