...
\[
    dB = \frac{\mu_0}{4 \pi} \frac{I |d\Vec{l} \times \hat{e_r}|}{r^2} = \frac{\mu_0}{4\pi} \frac{I dl}{\sqrt{\left( z^2 + r^2 \right)}}
\]
...
\begin{formulabox}
    \[
        B_z = \frac{\mu_0}{2}\frac{n}{l} I \left( \frac{z - z_1}{\sqrt{\left( z^2 - Z_1^2 \right) + r^2}} - \frac{z - z_2}{\sqrt{\left( z^2 - Z_2^2 \right) + r^2}}\right)
    \]
\end{formulabox} 
...
\textbf{Für unendlich langen Leiter $\phi_1 \rightarrow 0 \hspace{2mm}$und$\hspace{2mm} \phi_2 \rightarrow 180$ :}
\begin{formulabox}
    \[
...
\subsection{Kraft für zwischen zwei parallelen stromdurchflossenen Leiter:}
Kraft auf Leiter:
\[
...
\]
\\[1ex]
Abstand gegenüber der Länger der Leiter ist klein:
\[
...
Feldlinien von $\vec{B}-Felder$ bilder \textbf{geschlossene Schleifen} \\[1ex]
...
\begin{formulabox}
    \[
        \oint_C \vec{B} \cdot d\vec{l} \ = \ B \oint_C d\vec{l} \ = \ B \cdot 2\pi r_{\perp} \ != \ \mu_0 I_C \Rightarrow B = \frac{\mu_0 I_C}{2\pi r_{\perp}}
    \]
\end{formulabox}
