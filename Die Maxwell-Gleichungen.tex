...
\textbf{Verallgemeinertes Ampère'sches Gesetz}
\begin{formulabox}
    \[
...
Magnetfelder werden nicht nur von Strömen erzeugt, sondern auch von zeitlich variierenden elektrischen Felder. \\[2ex]

\textbf{Gegenstück zum Faraday'schen Gesetz}
\[
    U_{ind} = \oint_C \vec{E} \cdot d\vec{l} = - \frac{d}{dt} \Phi_{\text{mag}}
\]
...
\textbf{keine magnetischen Monopole}
\begin{formulabox}
    \[
        \vec{\nabla} \cdot \vec{B} = 0
    \]
...
\subsection{Die Wellengleichung für elektromagnetische Wellen}
...
\[
    \vec{E} \times \vec{B} = [E_0 \sin{(kx - \omega t)} \hat{e}_y] \times [B_0 \sin{(kx - \omega t)} \hat{e}_z]
\]
\begin{formulabox}
    \[
...
Die \textbf{Energiedichte} einer em-Welle $w_{em}$ setzt sich aus der elektrischen und magnetischen Energiedichte zusammen.\\[1ex]
...
\]
\textbf{Intensität} (mittlere Leistung pro Fläche senkrecht zur Ausbreitungsrichtung)
\begin{formulabox}
    \[
