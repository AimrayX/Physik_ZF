...
\]
\text{Einheit [C]: = Farad = F = $\frac{C}{V}$ = $\frac{Coulomb}{Volt}$}
...
Es gilt:
\[
    U = E \cdot d = \frac{\sigma}{\epsilon_0} \cdot d = \frac{g \cdot d}{\epsilon_0 \cdot A}
\]
$E = \frac{\sigma}{\epsilon_0}$: als $\Vec{E}-Feld$ ausserhalb der Oberfläche \\[1ex]
...
\[
    E_{el} = \int^q_0 dE_{el} = \int^q_0 \frac{q'}{C}dq' = \frac{1}{c}\int^q_0 q' dq' = \frac{1}{2}\frac{g^2}{C}
\]
...
\begin{formulabox}
    \[
        w_{el} = \frac{Energie}{Volumen} = \frac{1}{2}\epsilon_0 E^2
    \]
\end{formulabox}
...
\[
    U = \phi_A - \phi_B = U_1 + U_2 = \frac{q}{C_1} + \frac{q}{C_2} \Rightarrow q\left( \frac{1}{C_1} + \frac{1}{C_2} \right)
\]
...
$\Rightarrow \Vec{E} = \frac{\epsilon_0}{\varepsilon_{rel}}$ \\[1ex]
...
\begin{formulabox}
    \[
        \Rightarrow U = E \cdot d = \frac{\epsilon_0 \cdot d}{\varepsilon_{rel}} = \frac{U_0}{\varepsilon_{rel}}
    \]  
\end{formulabox}
\begin{formulabox}
    \[
